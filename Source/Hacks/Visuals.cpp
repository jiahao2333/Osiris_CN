...
void Visuals::drawGUI(bool contentOnly) noexcept
{
    ...
    ImGui::Checkbox("反重力布娃娃", &visualsConfig.inverseRagdollGravity);
    ImGui::Checkbox("禁用雾", &visualsConfig.noFog);
    ImGui::Checkbox("禁用3D天空", &visualsConfig.no3dSky);
    ImGui::Checkbox("禁用开火后座", &visualsConfig.noAimPunch);
    ...
    ImGui::Checkbox("禁用烟雾", &visualsConfig.noSmoke);
    ImGui::Checkbox("禁用模糊", &visualsConfig.noBlur);
    ImGui::Checkbox("禁用开镜覆盖", &visualsConfig.noScopeOverlay);
    ImGui::Checkbox("禁用草", &visualsConfig.noGrass);
    ImGui::Checkbox("禁用阴影", &visualsConfig.noShadows);
